...
<div class="login-error-message">
  Please Register or Login to proceed with Checkout!
...
<div class="form signup">
  ...
  <form name="logsignform"action="includes/cart.signup.inc.php" method="post">
...
<!-- LOGIN SCRIPT  -->
<script src="javascript/cart.login.js"></script>
