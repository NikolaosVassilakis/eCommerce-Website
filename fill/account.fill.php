...
<div class="account-container">
    <div class="account-flex">
        ...
        <section class="checkout-shipping bottom-line">

            <h2 class="section-heading"><i class="fa-solid fa-truck"></i> Shipping Details</h2>

            <div class="payment-form">

                <form action="includes/shipping.inc.php" method="post">
                <input type="hidden" name="userid" value="<?= $_SESSION['userid'] ?>">


                    <div class="half-flex">
                        <div class="account-input-container ls">
                            <label for="s-firstName" class="label-default">First Name <span
                                    class="asterisk">*</span></label>
                            <input type="text" name="sfn" id="s-firstName" class="input-default" value="<?= $_SESSION['sfirstname']; ?>" required>
                        </div>

                        <div class="account-input-container rs">
                            <label for="s-lastName" class="label-default">Last Name <span
                                    class="asterisk">*</span></label>
                            <input type="text" name="sln" id="s-lastName" class="input-default" value="<?= $_SESSION['slastname']; ?>" required>
                        </div>
                    </div>

                    <div class="account-input-container">
                        <label for="s-company" class="label-default">Company</label>
                        <input type="text" name="scom" id="s-company" class="input-default" value="<?= $_SESSION['scompany']; ?>">
                    </div>

                    <div class="account-input-container">
                        <label for="s-address1" class="label-default">Address 1 <span class="asterisk">*</span></label>
                        <input type="text" name="sad1" id="s-address1" class="input-default" value="<?= $_SESSION['saddress1']; ?>" required>
                    </div>

                    <div class="account-input-container">
                        <label for="s-address2" class="label-default">Address 2</label>
                        <input type="text" name="sad2" id="s-address2" class="input-default" value="<?= $_SESSION['saddress2']; ?>">
                    </div>
                    ...
                    <div class="half-flex">
                        <div class="account-input-container ls">
                            ...
                            <input type="text" name="scou" id="s-country" class="input-default" value="<?= $_SESSION['scountry']; ?>" required>
                        </div>

                        <div class="account-input-container rs">
                            <label for="s-city" class="label-default">Town / City <span
                                    class="asterisk">*</span></label>
                            <input type="text" name="sct" id="s-city" class="input-default" value="<?= $_SESSION['scity']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="half-flex">
                        <div class="account-input-container ls">
                            <label for="s-postcode" class="label-default">Postcode <span
                                    class="asterisk">*</span></label>
                            <input type="text" name="spc" id="s-postcode" class="input-default" value="<?= $_SESSION['spostcode']; ?>" required>
                        </div>

                        <div class="account-input-container rs">
                            <label for="s-telephone" class="label-default">Telephone number <span
                                    class="asterisk">*</span></label>
                            <input type="tel" name="stl" id="s-telephone" class="input-default" value="<?= $_SESSION['stelephone']; ?>" required>
                        </div>
                    </div>
...
?>
                    ...
                    <div class="payment-content">
                        <button class="payment-btn" name="save-shipping">
                            <b>SAVE DETAILS</b>
                        </button>
                    </div>
